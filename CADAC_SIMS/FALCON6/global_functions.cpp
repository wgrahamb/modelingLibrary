...
{	
	...
	ofstream fmerge("CADAC_SIMS/FALCON6/plot.asc");
...
void document_input(Document *doc_plane6)
{
	...
	fstream input1("CADAC_SIMS/FALCON6/input.asc");
	if(!input1){cout<<" *** Error: cannot open 'input.asc' file *** \n";system("pause");exit(1);}

	//open new copy file
	fstream fcopy("CADAC_SIMS/FALCON6/input_copy.asc");
	...
	ofstream input;
	input.open("CADAC_SIMS/FALCON6/input.asc",ios::out|ios::trunc);
