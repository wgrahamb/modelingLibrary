...
{	
	...
	ofstream fmerge("CADAC_SIMS/SRAAM6/plot.asc");
	...
	ifstream fplot1("CADAC_SIMS/SRAAM6/plot1.asc");
...
void document_input(Document *doc_missile6,Document *doc_target3)
{
	...
	fstream input1("CADAC_SIMS/SRAAM6/input.asc");
	if(!input1){cout<<" *** Error: cannot open 'input.asc' file *** \n";system("pause");exit(1);}

	//open new copy file
	fstream fcopy("CADAC_SIMS/SRAAM6/input_copy.asc");
	...
	ofstream input;
	input.open("CADAC_SIMS/SRAAM6/input.asc",ios::out|ios::trunc);
