...
int main() 
{
	...
	fstream input("CADAC_SIMS/SRAAM6/input.asc");
	if(input.fail())
	...
	for(int i=0;i<num_vehicles;i++)
	{
		...
		if(strstr(options,"y_plot"))
		{
			if(!strcmp(vehicle_name,"MISSILE6"))
			{
				...
				sprintf(index,"%i",i+1);
				plotiasc="CADAC_SIMS/SRAAM6/plot"+string(index)+".asc"; //using Standard Library string constructor
