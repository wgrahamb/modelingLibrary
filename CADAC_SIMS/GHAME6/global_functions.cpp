...
{	
	...
	ofstream fmerge("CADAC_SIMS/GHAME6/plot.asc");
	...
	ifstream fplot1("CADAC_SIMS/GHAME6/plot1.asc");
...
void document_input(Document *doc_hyper6,Document *doc_satellite3,Document *doc_radar0)
{
	...
	fstream input1("CADAC_SIMS/GHAME6/input.asc");
	if(!input1){cout<<" *** Error: cannot open 'input.asc' file *** \n";system("pause");exit(1);}

	//opening new copy file
	fstream fcopy("CADAC_SIMS/GHAME6/input_copy.asc");
	...
	ofstream input;
	input.open("CADAC_SIMS/GHAME6/input.asc",ios::out|ios::trunc);
