...
{	
	...
	ofstream fmerge("CADAC_SIMS/CRUISE5/plot.asc");
	...
	ifstream fplot1("CADAC_SIMS/CRUISE5/plot1.asc");
...
void document_input(Document *doc_cruise3,Document *doc_target3,Document *doc_satellite3)
{
	...
	fstream input1("CADAC_SIMS/CRUISE5/input.asc");
	if(!input1){cout<<" *** Error: cannot open 'input.asc' file *** \n";system("pause");exit(1);}

	//open new copy file
	fstream fcopy("CADAC_SIMS/CRUISE5/input_copy.asc");
	...
	ofstream input;
	input.open("CADAC_SIMS/CRUISE5/input.asc",ios::out|ios::trunc);
