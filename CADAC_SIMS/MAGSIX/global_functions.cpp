...
{	
	...
	ofstream fmerge("CADAC_SIMS/MAGSIX/plot.asc");
	...
	ifstream fplot1("CADAC_SIMS/MAGSIX/plot1.asc");
...
void document_input(Document *doc_rotor6)
{
	...
	fstream input1("CADAC_SIMS/MAGSIX/input.asc");
	if(!input1){cout<<" *** Error: cannot open 'input.asc' file *** \n";system("pause");exit(1);}

	//open new copy file
	fstream fcopy("CADAC_SIMS/MAGSIX/input_copy.asc");
	...
	ofstream input;
	input.open("CADAC_SIMS/MAGSIX/input.asc",ios::out|ios::trunc);
