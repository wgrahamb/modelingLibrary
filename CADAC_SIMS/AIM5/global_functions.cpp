...
{	
	...
	ofstream fmerge("CADAC_SIMS/AIM5/plot.asc");
	...
	ifstream fplot1("CADAC_SIMS/AIM5/plot1.asc");
...
void document_input(Document *doc_aim5,Document *doc_aircraft3)
{
	...
	fstream input1("CADAC_SIMS/AIM5/input.asc");
	if(!input1){cout<<" *** Error: cannot open 'input.asc' file *** \n";system("pause");exit(1);}

	//opening new copy file
	fstream fcopy("CADAC_SIMS/AIM5/input_copy.asc");
	...
	ofstream input;
	input.open("CADAC_SIMS/AIM5/input.asc",ios::out|ios::trunc);
