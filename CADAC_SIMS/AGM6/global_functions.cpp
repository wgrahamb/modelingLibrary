...
{	
	...
	ofstream fmerge("CADAC_SIMS/AGM6/plot.asc");
	...
	ifstream fplot1("CADAC_SIMS/AGM6/plot1.asc");
...
void document_input(Document *doc_missile6,Document *doc_target3,Document *doc_aircraft3)
{
	...
	fstream input1("CADAC_SIMS/AGM6/input.asc");
	if(!input1){cout<<" *** Error: cannot open 'input1.asc' file *** \n";system("pause");exit(1);}

	//opening new copy file
	fstream fcopy("CADAC_SIMS/AGM6/input_copy.asc");
...
//	}while(strcmp(buffl,"STOP"));
	...
	ofstream input;
	input.open("CADAC_SIMS/AGM6/input.asc",ios::out|ios::trunc);
