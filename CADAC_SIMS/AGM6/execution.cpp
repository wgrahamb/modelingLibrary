...
int main() 
{
	...
	fstream input("CADAC_SIMS/AGM6/input.asc");
	if(input.fail())
			...
			{		
				...
				if(strstr(options,"y_plot"))
				{
					if(!strcmp(vehicle_name,"MISSILE6"))
					{
						...
						sprintf(index,"%i",i+1);
						plotiasc="CADAC_SIMS/AGM6/plot"+string(index)+".asc"; //using Standard Library string constructor
