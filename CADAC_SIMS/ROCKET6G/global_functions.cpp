...
{	
	...
	ofstream fmerge("CADAC_SIMS/ROCKET6G/plot.asc");
	...
	ifstream fplot1("CADAC_SIMS/ROCKET6G/plot1.asc");
...
void document_input(Document *doc_hyper6)
{
	...
	fstream input1("CADAC_SIMS/ROCKET6G/input.asc");
	if(!input1){cout<<" *** Error: cannot open 'input.asc' file *** \n";system("pause");exit(1);} 

	//opening new copy file
	fstream fcopy("CADAC_SIMS/ROCKET6G/input_copy.asc");
	...
	ofstream input;
	input.open("CADAC_SIMS/ROCKET6G/input.asc",ios::out|ios::trunc);
