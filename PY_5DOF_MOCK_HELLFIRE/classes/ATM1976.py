...
class ATM1976:
	...
	def __init__(self):
		...
		self.htab    = [0.0, 11.0, 20.0, 32.0,
			47.0, 51.0, 71.0, 84.852] #altitude
		self.ttab    = [288.15, 216.65, 216.65, 228.65, 270.65,
			270.65, 214.65, 186.946] #temperature
		self.ptab    = [1.0, 2.233611e-1, 5.403295e-2, 8.5666784e-3,
			1.0945601e-3, 6.6063531e-4, 3.9046834e-5, 3.68501e-6]  #pressure
		self.gtab    = [-6.5, 0.0, 1.0, 2.8,
