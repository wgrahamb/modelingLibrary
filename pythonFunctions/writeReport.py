...
if __name__ == "__main__":
	...
	compareTwoFiles(
		reportRelPath="PY_5DOF_MOCK_HELLFIRE/data/report.pdf",
		refFileRelPath="PY_5DOF_MOCK_HELLFIRE/data/MOCK_HELLFIRE5DOF.txt",
		newFileRelPath="PY_5DOF_MOCK_HELLFIRE/data/MOCK_HELLFIRE5DOF.txt",
		xAxisKey="TOF"
	)
